...
class Message(models.Model):
    ...
    def reply_to_message(self, reply_content: str) -> object:
        new_sender = self.receiver
        new_receiver = self.sender
        new_msg = Message.objects.create(sender=new_sender,
                                         receiver=new_receiver,
                                         content=reply_content)
        return new_msg

    def forward_message(self, receiver: UserProfile) -> object:
        new_sender = self.receiver
