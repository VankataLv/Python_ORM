# Generated by Django 5.0.4 on 2024-08-01 11:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_awarded', models.BooleanField(default=False)),
                ('last_updated', models.DateTimeField(auto_now=True)),
                ('actors', models.ManyToManyField(related_name='cast', to='main_app.actor')),
                ('director', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='director_movies', to='main_app.director')),
                ('starring_actor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='star_movies', to='main_app.actor')),
            ],
        ),
    ]
